package com.zy.java.common.service.datasyc;
...
import com.zy.java.common.annotation.DataSync;
import com.zy.java.common.cst.CST;
import com.zy.java.common.utils.PackageUtils;
...
public class BaseSyncService implements ApplicationContextAware {
	...
	@Pointcut("@annotation(com.zy.java.common.annotation.DataSync)")
	public void sync() {
	}
